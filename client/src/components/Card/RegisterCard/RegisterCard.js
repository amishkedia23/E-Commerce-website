        ...
        <div className="register__card__container">
            <div className="register__card">
                ...
                <div className="fname__input__container reg__input__container">
                        ...
                        <input type="text" className="fname__input register__input"  placeholder='Anusha'/>
                    </div>
                    <div className="lname__input__container reg__input__container">
                        <label className="lname__label input__label">Last name</label>
                        <input type="text" className="lname__input register__input" placeholder='Bera'/>
                    </div>
                    ...
                    <div className="password__input__container reg__input__container">
                        ...
                        <input type="password" className="password__input register__input" placeholder='*********' />
                    </div>
